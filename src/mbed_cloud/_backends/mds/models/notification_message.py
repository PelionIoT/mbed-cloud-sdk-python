...
class NotificationMessage(object):
    ...
    def __init__(self, async_responses=None, de_registrations=None, reg_updates=None, registrations=None, notifications=None, registrations_expired=None):
        ...
        self._async_responses = None
        self._de_registrations = None
        self._reg_updates = None
        self._registrations = None
        self._notifications = None
        self._registrations_expired = None
        self.discriminator = None

        if async_responses is not None:
          self.async_responses = async_responses
        if de_registrations is not None:
          self.de_registrations = de_registrations
        if reg_updates is not None:
          self.reg_updates = reg_updates
        if registrations is not None:
          self.registrations = registrations
        if notifications is not None:
          self.notifications = notifications
        if registrations_expired is not None:
          self.registrations_expired = registrations_expired
