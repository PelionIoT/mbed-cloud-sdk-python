...
------------- | ------------- | -------------
[**v2_notification_callback_delete**](NotificationsApi.md#v2_notification_callback_delete) | **DELETE** /v2/notification/callback | Delete callback URL
[**v2_notification_callback_get**](NotificationsApi.md#v2_notification_callback_get) | **GET** /v2/notification/callback | Check callback URL
...
try: 
    ...
    print("Exception when calling NotificationsApi->v2_notification_callback_delete: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling NotificationsApi->v2_notification_callback_get: %s\n" % e)
```
