...
class Metric(object):
    ...
    def __init__(self, registration_updates=None, connect_rest_api_success=None, bootstraps_failed=None, transactions=None, timestamp=None, device_subscription_request_error=None, bootstraps_pending=None, device_proxy_request_success=None, bootstraps_successful=None, full_registrations=None, device_subscription_request_success=None, expired_registrations=None, handshakes_successful=None, device_observations=None, device_proxy_request_error=None, deleted_registrations=None, connect_rest_api_error=None, id=None):
        ...
        self._registration_updates = None
        self._connect_rest_api_success = None
        self._bootstraps_failed = None
        self._transactions = None
        self._timestamp = None
        self._device_subscription_request_error = None
        self._bootstraps_pending = None
        self._device_proxy_request_success = None
        self._bootstraps_successful = None
        self._full_registrations = None
        self._device_subscription_request_success = None
        self._expired_registrations = None
        self._handshakes_successful = None
        self._device_observations = None
        self._device_proxy_request_error = None
        self._deleted_registrations = None
        self._connect_rest_api_error = None
        self._id = None

        if registration_updates is not None:
          self.registration_updates = registration_updates
        if connect_rest_api_success is not None:
          self.connect_rest_api_success = connect_rest_api_success
        ...
        if device_subscription_request_error is not None:
          self.device_subscription_request_error = device_subscription_request_error
        if bootstraps_pending is not None:
          self.bootstraps_pending = bootstraps_pending
        if device_proxy_request_success is not None:
          self.device_proxy_request_success = device_proxy_request_success
        if bootstraps_successful is not None:
          self.bootstraps_successful = bootstraps_successful
        if full_registrations is not None:
          self.full_registrations = full_registrations
        if device_subscription_request_success is not None:
          self.device_subscription_request_success = device_subscription_request_success
        if expired_registrations is not None:
          self.expired_registrations = expired_registrations
        ...
        if device_proxy_request_error is not None:
          self.device_proxy_request_error = device_proxy_request_error
        if deleted_registrations is not None:
          self.deleted_registrations = deleted_registrations
        if connect_rest_api_error is not None:
          self.connect_rest_api_error = connect_rest_api_error
        if id is not None:
          self.id = id
