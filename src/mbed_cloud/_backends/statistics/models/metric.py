...
class Metric(object):
    ...
    def registration_updates(self):
        """Gets the registration_updates of this Metric.  # noqa: E501

        The number of registration updates linked to the account. Registration update is the process of updating the registration status with the Mbed Cloud Connect to update or extend the lifetime of the device.  # noqa: E501

        :return: The registration_updates of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def registration_updates(self, registration_updates):
        ...
        :param registration_updates: The registration_updates of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def connect_rest_api_success(self):
        """Gets the connect_rest_api_success of this Metric.  # noqa: E501

        The number of successful [Connect API](/docs/v1.2/service-api-references/connect-api.html) requests the account has performed. The metric do not consider the actual response from the device and it includes only the result of the http request used to subscibe to the device resources.  # noqa: E501

        :return: The connect_rest_api_success of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def connect_rest_api_success(self, connect_rest_api_success):
        ...
        :param connect_rest_api_success: The connect_rest_api_success of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def bootstraps_failed(self):
        """Gets the bootstraps_failed of this Metric.  # noqa: E501

        The number of failed bootstraps the account has performed. Bootstrap is the process of provisioning a Lightweight Machine to Machine Client to a state where it can initiate a management session to a new Lightweight Machine to Machine Server.  # noqa: E501

        :return: The bootstraps_failed of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def bootstraps_failed(self, bootstraps_failed):
        ...
        :param bootstraps_failed: The bootstraps_failed of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def transactions(self):
        """Gets the transactions of this Metric.  # noqa: E501
        ...
        :return: The transactions of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def transactions(self, transactions):
        ...
        :param transactions: The transactions of this Metric.  # noqa: E501
        :type: int
        """
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this Metric.  # noqa: E501

        UTC time in RFC3339 format. The timestamp is the starting point of the interval for which the data is aggregated. Each interval includes data for the time greater than or equal to the timestamp and less than the next interval's starting point.  # noqa: E501

        :return: The timestamp of this Metric.  # noqa: E501
        :rtype: datetime
        """
    ...
    def timestamp(self, timestamp):
        ...
        :param timestamp: The timestamp of this Metric.  # noqa: E501
        :type: datetime
        """
    ...
    def device_subscription_request_error(self):
        """Gets the device_subscription_request_error of this Metric.  # noqa: E501

        **(Beta)** The number of failed subscription requests from Mbed Cloud Connect to devices linked to the account. The subscription requests are made from Mbed Cloud Connect to devices when you try to subscribe to a resource path using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501

        :return: The device_subscription_request_error of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def device_subscription_request_error(self, device_subscription_request_error):
        ...
        **(Beta)** The number of failed subscription requests from Mbed Cloud Connect to devices linked to the account. The subscription requests are made from Mbed Cloud Connect to devices when you try to subscribe to a resource path using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501
        ...
        :param device_subscription_request_error: The device_subscription_request_error of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def bootstraps_pending(self):
        """Gets the bootstraps_pending of this Metric.  # noqa: E501

        The number of pending bootstraps the account has performed. Bootstrap is the process of provisioning a Lightweight Machine to Machine Client to a state where it can initiate a management session to a new Lightweight Machine to Machine Server.  # noqa: E501

        :return: The bootstraps_pending of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def bootstraps_pending(self, bootstraps_pending):
        ...
        :param bootstraps_pending: The bootstraps_pending of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def device_proxy_request_success(self):
        """Gets the device_proxy_request_success of this Metric.  # noqa: E501

        **(Beta)** The number of successful proxy requests from Mbed Cloud Connect to devices linked to the account. The proxy requests are made from Mbed Cloud Connect to devices when you try to read or write values to device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501

        :return: The device_proxy_request_success of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def device_proxy_request_success(self, device_proxy_request_success):
        ...
        **(Beta)** The number of successful proxy requests from Mbed Cloud Connect to devices linked to the account. The proxy requests are made from Mbed Cloud Connect to devices when you try to read or write values to device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501
        ...
        :param device_proxy_request_success: The device_proxy_request_success of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def bootstraps_successful(self):
        """Gets the bootstraps_successful of this Metric.  # noqa: E501

        The number of successful bootstraps the account has performed. Bootstrap is the process of provisioning a Lightweight Machine to Machine Client to a state where it can initiate a management session to a new Lightweight Machine to Machine Server.  # noqa: E501

        :return: The bootstraps_successful of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def bootstraps_successful(self, bootstraps_successful):
        ...
        :param bootstraps_successful: The bootstraps_successful of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def full_registrations(self):
        """Gets the full_registrations of this Metric.  # noqa: E501
        ...
        :return: The full_registrations of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def full_registrations(self, full_registrations):
        ...
        :param full_registrations: The full_registrations of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def device_subscription_request_success(self):
        """Gets the device_subscription_request_success of this Metric.  # noqa: E501

        **(Beta)** The number of successful subscription requests from Mbed Cloud Connect to devices linked to the account. The subscription requests are made from Mbed Cloud Connect to devices when you try to subscribe to a resource path using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501

        :return: The device_subscription_request_success of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def device_subscription_request_success(self, device_subscription_request_success):
        ...
        **(Beta)** The number of successful subscription requests from Mbed Cloud Connect to devices linked to the account. The subscription requests are made from Mbed Cloud Connect to devices when you try to subscribe to a resource path using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501
        ...
        :param device_subscription_request_success: The device_subscription_request_success of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def expired_registrations(self):
        """Gets the expired_registrations of this Metric.  # noqa: E501

        The number of expired registrations linked to the account. Mbed Cloud Connect removes the device registrations when the devices cannot update their registration before the expiry of the lifetime. Mbed Cloud Connect no longer handles requests for a device whose registration has expired already.  # noqa: E501

        :return: The expired_registrations of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def expired_registrations(self, expired_registrations):
        ...
        :param expired_registrations: The expired_registrations of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def handshakes_successful(self, handshakes_successful):
        ...
        :param handshakes_successful: The handshakes_successful of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def device_observations(self):
        """Gets the device_observations of this Metric.  # noqa: E501

        **(Beta)** The number of observations received by Mbed Cloud Connect from the devices linked to the account. The observations are pushed from the device to Mbed Cloud Connect when you have successfully subscribed to the device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501

        :return: The device_observations of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def device_observations(self, device_observations):
        ...
        **(Beta)** The number of observations received by Mbed Cloud Connect from the devices linked to the account. The observations are pushed from the device to Mbed Cloud Connect when you have successfully subscribed to the device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501
        ...
        :param device_observations: The device_observations of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def device_proxy_request_error(self):
        """Gets the device_proxy_request_error of this Metric.  # noqa: E501

        **(Beta)** The number of failed proxy requests from Mbed Cloud Connect to devices linked to the account. The proxy requests are made from Mbed Cloud Connect to devices when you try to read or write values to device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501

        :return: The device_proxy_request_error of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def device_proxy_request_error(self, device_proxy_request_error):
        ...
        **(Beta)** The number of failed proxy requests from Mbed Cloud Connect to devices linked to the account. The proxy requests are made from Mbed Cloud Connect to devices when you try to read or write values to device resources using [Connect API](/docs/v1.2/service-api-references/connect-api.html) endpoints.   # noqa: E501
        ...
        :param device_proxy_request_error: The device_proxy_request_error of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def deleted_registrations(self, deleted_registrations):
        ...
        :param deleted_registrations: The deleted_registrations of this Metric.  # noqa: E501
        :type: int
        """
    ...
    def connect_rest_api_error(self):
        """Gets the connect_rest_api_error of this Metric.  # noqa: E501

        The number of failed [Connect API](/docs/v1.2/service-api-references/connect-api.html) requests the account has performed.The metric do not consider the actual response from the device and it includes only the result of the http request used to subscibe to the device resources.  # noqa: E501

        :return: The connect_rest_api_error of this Metric.  # noqa: E501
        :rtype: int
        """
    ...
    def connect_rest_api_error(self, connect_rest_api_error):
        ...
        :param connect_rest_api_error: The connect_rest_api_error of this Metric.  # noqa: E501
        :type: int
        """
