...
class PolicyCreationReq(object):
    ...
    def __init__(self, actions=None, apikeys=None, conditions=None, description=None, error_message=None, grant_expires_in=None, groups=None, name=None, not_actions=None, not_conditions=None, not_resources=None, resources=None, status=None, tag=None, users=None, valid_from=None, valid_until=None):
        """
