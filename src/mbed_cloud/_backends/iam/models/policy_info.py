...
class PolicyInfo(object):
    ...
    def __init__(self, account_id=None, actions=None, apikeys=None, conditions=None, created_at=None, description=None, error_message=None, etag=None, grant_expires_in=None, groups=None, id=None, name=None, not_actions=None, not_conditions=None, not_resources=None, object=None, resources=None, status=None, tag=None, updated_at=None, users=None, valid_from=None, valid_until=None):
        """
