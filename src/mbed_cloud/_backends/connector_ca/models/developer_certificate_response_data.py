...
class DeveloperCertificateResponseData(object):
    ...
    def __init__(self, security_file_content=None, description=None, name=None, developer_certificate=None, server_uri=None, created_at=None, object=None, developer_private_key=None, server_certificate=None, etag=None, id=None, account_id=None):
        ...
        self._security_file_content = None
        self._description = None
        self._name = None
        self._developer_certificate = None
        self._server_uri = None
        self._created_at = None
        self._object = None
        self._developer_private_key = None
        ...
        if security_file_content is not None:
          self.security_file_content = security_file_content
        if description is not None:
          self.description = description
        if name is not None:
          self.name = name
        if developer_certificate is not None:
          self.developer_certificate = developer_certificate
        ...
        if object is not None:
          self.object = object
        if developer_private_key is not None:
          self.developer_private_key = developer_private_key
