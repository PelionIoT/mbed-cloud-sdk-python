...
from mbed_cloud.sdk.entity import Entity
...
class PSK(Entity):
    ...
    def __init__(
        ...
        :param created_at: The date-time (RFC3339) when this pre-shared key was uploaded to Mbed
            Cloud.
        :type created_at: string
        :param endpoint_name: The unique endpoint identifier that this pre-shared key applies to.
            16-64
    ...
    @property
    def secret_hex(self):
        """The secret of the pre-shared key in hexadecimal. It is not case sensitive; 4a
        is same as 4A, and it is allowed with or without 0x in the beginning. The
    ...
    def create(self):
        ...
        api documentation:
        https://os.mbed.com/search/?q=service+apis+/v2/device-shared-keys
        """
    ...
    def delete(self):
        ...
        api documentation:
        https://os.mbed.com/search/?q=service+apis+/v2/device-shared-keys/{endpoint_name}
        """
...
class SubtenantAccount(Entity):
    ...
    def __init__(
        ...
        :param admin_name: The username of the admin user to be created, containing
            alphanumerical letters and -,._@+= characters. It must be at least 4
            but not more than 30 character long.
        :type admin_name: string
        :param admin_password: The password when creating a new user. It will be generated when not
...
class User(Entity):
    ...
    def __init__(
        ...
        :type email: string
        :param email_verified: A flag indicating whether the user's email address has been verified
            or not.
        ...
        :type last_login_time: integer
        :param login_history: Timestamps, succeedings, IP addresses and user agent information of
            the last five logins of the user, with timestamps in RFC3339 format.
        ...
        :param password: The password when creating a new user. It will be generated when not
            present in the request.
        ...
        :type phone_number: string
        :param status: The status of the user. ENROLLING state indicates that the user is in
            the middle of the enrollment process. INVITED means that the user has
            not accepted the invitation request. RESET means that the password
            must be changed immediately. INACTIVE users are locked out and not
