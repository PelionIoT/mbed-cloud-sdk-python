...
DeviceUpdate Foundation Entities
=================================

This module contains the Foundation Entities that are grouped together under the DeviceUpdate category:
...
How to import DeviceUpdate Entities:
