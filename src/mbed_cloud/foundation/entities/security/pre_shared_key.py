...
class PreSharedKey(Entity):
    ...
    def __init__(self, _client=None, created_at=None, endpoint_name=None):
        ...
        :param endpoint_name: (Required) The unique endpoint identifier that this pre-shared key applies
    ...
    @property
    def created_at(self):
        """The date-time (RFC3339) when this pre-shared key was uploaded to Pelion device
        management.
    ...
    def create(self, secret_hex):
        ...
        :param secret_hex: The secret of the pre-shared key in hexadecimal. It is not case
            sensitive; 4a is same as 4A, and it is allowed with or without 0x in
            the beginning. The minimum length of the secret is 128 bits and
            maximum 256 bits.
        :type secret_hex: str
