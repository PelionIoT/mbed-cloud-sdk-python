...
class OIDCRequest(Entity):
    ...
    def __init__(
        ...
        self._keys = fields.ListField(value=keys, entity=IdpPublicKey)
        ...
        self._token_request_mode = fields.StringField(
            value=token_request_mode, enum=enums.OIDCRequestTokenRequestModeEnum
        )
