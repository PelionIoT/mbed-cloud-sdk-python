"""
.. warning::
    PolicyGroup should not be imported directly from this module as the
    organisation may change in the future, please use the :mod:`mbed_cloud.foundation` module to import entities.

Foundation Entity: PolicyGroup
==============================
...
- :meth:`PolicyGroup.api_keys`
- :meth:`PolicyGroup.create`
- :meth:`PolicyGroup.delete`
- :meth:`PolicyGroup.list`
- :meth:`PolicyGroup.read`
- :meth:`PolicyGroup.update`
- :meth:`PolicyGroup.users`
...
How to import PolicyGroup directly:
...
class PolicyGroup(Entity):
    """Represents the `PolicyGroup` entity in Pelion Device Management"""
    ...
    def id(self):
        ...
        This field must be set when updating or deleting an existing PolicyGroup Entity.
    ...
    def name(self):
        ...
        This field must be set when creating a new PolicyGroup Entity.
    ...
    def list(self, filter=None, order="ASC", max_results=None, page_size=50, include=None):
        ...
        **API Filters**
        ...
        The following filters are supported by the API when listing PolicyGroup entities:
        ...
        **Example Usage**
        ...
        .. code-block:: python
            ...
            for policy_group in PolicyGroup().list(filter=api_filter):
                print(policy_group.name)
    ...
    def _paginate_api_keys(self, after=None, filter=None, order="ASC", limit=50, include=None):
        ...
        query_params["order"] = fields.StringField(order, enum=enums.PolicyGroupOrderEnum).to_api()
    ...
    def users(self, filter=None, order="ASC", max_results=None, page_size=50, include=None):
        ...
        **Example Usage**
        ...
        .. code-block:: python
            ...
            for user in PolicyGroup().users(filter=api_filter):
                print(user.status)
