...
class LightThemeColor(Entity):
    ...
    _fieldnames = ["color", "reference", "updated_at"]
    ...
    def __init__(self, _client=None, color=None, reference=None, updated_at=None):
        ...
        self._reference = fields.StringField(
            value=reference, enum=enums.LightThemeColorReferenceEnum
        )
    ...
    def list(self, filter=None, order=None, max_results=None, page_size=None, include=None):
        ...
        if isinstance(filter, dict):
            filter = ApiFilter(
                filter_definition=filter, field_renames=DarkThemeColor._renames_to_api
            )
    ...
    def update(self):
        ...
        return self._client.call_api(
            ...
            content_type="application/json",
            body_params={
                "color": self._color.to_api(),
                "updated_at": self._updated_at.to_api(),
            },
            path_params={"reference": self._reference.to_api()},
            unpack=self,
        )
