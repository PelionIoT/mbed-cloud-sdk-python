...
------------- | ------------- | -------------
[**add_account_certificate**](RootAdminApi.md#add_account_certificate) | **POST** /v3/accounts/{accountID}/ca-certificates | Upload new CA certificate.
...
[**delete_account_certificate**](RootAdminApi.md#delete_account_certificate) | **DELETE** /v3/accounts/{accountID}/ca-certificates/{ca-cert-id} | Delete CA certificate by ID.
...
[**get_account_certificate**](RootAdminApi.md#get_account_certificate) | **GET** /v3/accounts/{accountID}/ca-certificates/{ca-cert-id} | Get CA certificate by ID.
...
[**get_all_account_certificates**](RootAdminApi.md#get_all_account_certificates) | **GET** /v3/accounts/{accountID}/ca-certificates | Get all CA certificates.
...
[**update_account_certificate**](RootAdminApi.md#update_account_certificate) | **PUT** /v3/accounts/{accountID}/ca-certificates/{ca-cert-id} | Update CA certificate.
...
> CACertificateResp add_account_certificate(account_id, body)
...
> delete_account_certificate(account_id, ca_cert_id)
...
try: 
    # Delete CA certificate by ID.
    api_instance.delete_account_certificate(account_id, ca_cert_id)
except ApiException as e:
...
# **delete_account_user**
> delete_account_user(account_id, user_id, force=force)
...
try: 
    # Delete a user.
    api_instance.delete_account_user(account_id, user_id, force=force)
except ApiException as e:
...
> CACertificateResp get_account_certificate(account_id, ca_cert_id)
...
try: 
    # Get CA certificate by ID.
    api_response = api_instance.get_account_certificate(account_id, ca_cert_id)
    pprint(api_response)
except ApiException as e:
...
include = 'include_example' # str | Comma separated additional data to return. Currently supported: limits, policies (optional)
 ...
 **include** | **str**| Comma separated additional data to return. Currently supported: limits, policies | [optional] 
...
> ApiKeyInfoRespList get_all_account_api_keys(account_id, limit=limit, after=after, order=order, include=include, filter=filter, owner=owner)
...
try: 
    # Get all API keys.
    api_response = api_instance.get_all_account_api_keys(account_id, limit=limit, after=after, order=order, include=include, filter=filter, owner=owner)
    pprint(api_response)
except ApiException as e:
...
> CACertificateRespList get_all_account_certificates(account_id, limit=limit, after=after, order=order, include=include, filter=filter)
...
order = 'ASC' # str | The order of the records, ASC or DESC; by default ASC (optional) (default to ASC)
include = 'include_example' # str | Comma separated additional data to return. Currently supported: total_count (optional)
filter = 'filter_example' # str | Filter for the query, for example filter=service%3Dlwm2m,expire%3D180. (optional)

try: 
    # Get all CA certificates.
    api_response = api_instance.get_all_account_certificates(account_id, limit=limit, after=after, order=order, include=include, filter=filter)
    pprint(api_response)
except ApiException as e:
 ...
 **order** | **str**| The order of the records, ASC or DESC; by default ASC | [optional] [default to ASC]
 **include** | **str**| Comma separated additional data to return. Currently supported: total_count | [optional] 
 **filter** | **str**| Filter for the query, for example filter&#x3D;service%3Dlwm2m,expire%3D180. | [optional] 
...
> UserInfoRespList get_all_account_users(account_id, limit=limit, after=after, order=order, include=include, filter=filter)
...
try: 
    # Get all user details.
    api_response = api_instance.get_all_account_users(account_id, limit=limit, after=after, order=order, include=include, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_all_accounts**
> AccountInfoList get_all_accounts(status=status, tier=tier, parent=parent, limit=limit, after=after, include=include, filter=filter)
...
# create an instance of the API class
api_instance = iam.RootAdminApi()
status = 'status_example' # str | An optional filter for account status, ENROLLING, ACTIVE, SUSPENDED or DISABLED. (optional)
...
filter = 'filter_example' # str | Filter for the query, for example filter=tier%3D1 or status%3DACTIVE. (optional)

try: 
    # Get all accounts.
    api_response = api_instance.get_all_accounts(status=status, tier=tier, parent=parent, limit=limit, after=after, include=include, filter=filter)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **status** | **str**| An optional filter for account status, ENROLLING, ACTIVE, SUSPENDED or DISABLED. | [optional] 
 ...
 **filter** | **str**| Filter for the query, for example filter&#x3D;tier%3D1 or status%3DACTIVE. | [optional] 
...
> UserInfoRespList get_all_accounts_all_users(limit=limit, after=after, order=order, include=include, filter=filter)
...
try: 
    # Get all users from all accounts
    api_response = api_instance.get_all_accounts_all_users(limit=limit, after=after, order=order, include=include, filter=filter)
    pprint(api_response)
except ApiException as e:
...
status = 'status_example' # str | New status of the account; ACTIVE, SUSPENDED or DISABLED (optional)
 ...
 **status** | **str**| New status of the account; ACTIVE, SUSPENDED or DISABLED | [optional] 
...
> CACertificateResp update_account_certificate(account_id, ca_cert_id, body)
...
try: 
    # Update CA certificate.
    api_response = api_instance.update_account_certificate(account_id, ca_cert_id, body)
    pprint(api_response)
except ApiException as e:
...
body = iam.RootAdminUpdateReq() # RootAdminUpdateReq | A rootadmin user object with attributes.
 ...
 **body** | [**RootAdminUpdateReq**](RootAdminUpdateReq.md)| A rootadmin user object with attributes. | 
