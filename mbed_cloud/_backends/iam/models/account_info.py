...
class AccountInfo(object):
    ...
    """
    def __init__(self, status=None, postal_code=None, id=None, aliases=None, address_line2=None, city=None, address_line1=None, display_name=None, parent_id=None, state=None, etag=None, is_provisioning_allowed=False, creation_time_millis=None, email=None, phone_number=None, company=None, object=None, upgraded_at=None, tier=None, sub_accounts=None, limits=None, country=None, created_at=None, contact=None, policies=None, template_id=None):
        """
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ENROLLING", "ACTIVE", "SUSPENDED", "DISABLED"]
    ...
    def creation_time_millis(self):
        """
        Gets the creation_time_millis of this AccountInfo.

        :return: The creation_time_millis of this AccountInfo.
        :rtype: int
        """
    ...
    def creation_time_millis(self, creation_time_millis):
        """
        Sets the creation_time_millis of this AccountInfo.

        :param creation_time_millis: The creation_time_millis of this AccountInfo.
        :type: int
        """
