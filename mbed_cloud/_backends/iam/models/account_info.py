...
class AccountInfo(object):
    ...
    """
    def __init__(self, address_line2=None, city=None, address_line1=None, display_name=None, upgraded_at=None, country=None, company=None, object=None, status=None, id=None, email=None, state=None, etag=None, postal_code=None, contact=None, is_provisioning_allowed=False, tier=None, phone_number=None, created_at=None, aliases=None):
        """
