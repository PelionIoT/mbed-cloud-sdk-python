...
class AccountInfo(object):
    ...
    """
    def __init__(self, status=None, postal_code=None, parent_id=None, id=None, aliases=None, address_line2=None, city=None, address_line1=None, display_name=None, state=None, etag=None, is_provisioning_allowed=False, creation_time_millis=None, email=None, phone_number=None, company=None, object=None, upgraded_at=None, sub_accounts=None, tier=None, limits=None, country=None, created_at=None, contact=None, policies=None, template_id=None):
        """
