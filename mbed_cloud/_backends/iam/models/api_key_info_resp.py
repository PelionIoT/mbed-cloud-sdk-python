...
class ApiKeyInfoResp(object):
    ...
    """
    def __init__(self, groups=None, status=None, name=None, created_at=None, object=None, creation_time=None, creation_time_millis=None, etag=None, key=None, owner=None, id=None, last_login_time=None):
        """
