...
class ApiKeyInfoResp(object):
    ...
    """
    def __init__(self, status=None, apikey=None, name=None, created_at=None, object=None, creation_time=None, etag=None, groups=None, owner=None, secret_key=None, id=None, last_login_time=None):
        """
