...
class TrustedCertificateResp(object):
    ...
    """
    def __init__(self, description=None, service=None, device_execution_mode=None, created_at=None, object=None, subject=None, account_id=None, etag=None, validity=None, issuer=None, cert_data=None, id=None, name=None):
        """
