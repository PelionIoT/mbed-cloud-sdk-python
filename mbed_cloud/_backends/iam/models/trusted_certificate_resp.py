...
class TrustedCertificateResp(object):
    ...
    """
    def __init__(self, account_id=None, service=None, created_at=None, object=None, subject=None, validity=None, etag=None, attestation_method=None, creation_time_millis=None, issuer=None, cert_data=None, id=None, name=None):
        """
    ...
    def attestation_method(self):
        """
        Gets the attestation_method of this TrustedCertificateResp.
        Attestation method where zero means a developer certificate.

        :return: The attestation_method of this TrustedCertificateResp.
        :rtype: int
        """
    ...
    def attestation_method(self, attestation_method):
        """
        Sets the attestation_method of this TrustedCertificateResp.
        Attestation method where zero means a developer certificate.

        :param attestation_method: The attestation_method of this TrustedCertificateResp.
        :type: int
        """
        if attestation_method is None:
            raise ValueError("Invalid value for `attestation_method`, must not be `None`")
