...
class AccountUpdateReq(object):
    ...
    """
    def __init__(self, address_line2=None, city=None, password_policy=None, display_name=None, country=None, company=None, idle_timeout=None, contact=None, state=None, address_line1=None, postal_code=None, end_market=None, phone_number=None, email=None, aliases=None):
        """
