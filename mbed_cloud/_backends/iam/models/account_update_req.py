...
class AccountUpdateReq(object):
    ...
    def __init__(self, address_line2=None, city=None, address_line1=None, display_name=None, country=None, company=None, idle_timeout=None, state=None, contact=None, postal_code=None, end_market=None, phone_number=None, email=None, aliases=None):
        """
        ...
        if end_market is not None:
          self.end_market = end_market
