...
class AccountUpdateReq(object):
    ...
    """
    def __init__(self, address_line2=None, city=None, address_line1=None, display_name=None, country=None, company=None, state=None, contact=None, postal_code=None, phone_number=None, email=None, aliases=None):
        """
