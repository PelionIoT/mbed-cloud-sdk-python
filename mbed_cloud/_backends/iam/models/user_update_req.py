...
class UserUpdateReq(object):
    ...
    """
    def __init__(self, username=None, phone_number=None, is_marketing_accepted=None, is_gtc_accepted=None, full_name=None, address=None, password=None, email=None):
        """
