...
class UserUpdateReq(object):
    ...
    """
    def __init__(self, status=None, username=None, is_marketing_accepted=None, is_gtc_accepted=None, email=None, full_name=None, address=None, password=None, phone_number=None, is_totp_enabled=None):
        """
