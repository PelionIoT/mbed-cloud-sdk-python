...
class GroupSummary(object):
    ...
    """
    def __init__(self, apikey_count=None, name=None, last_update_time=None, created_at=None, object=None, creation_time=None, user_count=None, etag=None, id=None, account_id=None):
        """
