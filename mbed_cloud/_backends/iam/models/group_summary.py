...
class GroupSummary(object):
    ...
    """
    def __init__(self, user_count=None, name=None, last_update_time=None, created_at=None, object=None, creation_time=None, etag=None, apikey_count=None, id=None, account_id=None):
        """
