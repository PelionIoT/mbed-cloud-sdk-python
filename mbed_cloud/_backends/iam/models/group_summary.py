...
class GroupSummary(object):
    ...
    """
    def __init__(self, name=None, last_update_time=None, api_key_count=None, created_at=None, object=None, creation_time=None, etag=None, user_count=None, id=None, account_id=None):
        """
