...
class AccountUpdateRootReq(object):
    ...
    """
    def __init__(self, address_line2=None, city=None, address_line1=None, display_name=None, is_provisioning_allowed=None, limits=None, country=None, company=None, reason=None, template_id=None, status=None, state=None, contact=None, postal_code=None, policies=None, parent_id=None, tier=None, phone_number=None, email=None, aliases=None):
        """
