...
class TrustedCertificateInternalResp(object):
    ...
    """
    def __init__(self, private_key=None, description=None, service=None, device_execution_mode=None, created_at=None, object=None, subject=None, account_id=None, etag=None, validity=None, creation_time_millis=None, issuer=None, cert_data=None, id=None, name=None):
        """
    ...
    def creation_time_millis(self):
        """
        Gets the creation_time_millis of this TrustedCertificateInternalResp.

        :return: The creation_time_millis of this TrustedCertificateInternalResp.
        :rtype: int
        """
    ...
    def creation_time_millis(self, creation_time_millis):
        """
        Sets the creation_time_millis of this TrustedCertificateInternalResp.

        :param creation_time_millis: The creation_time_millis of this TrustedCertificateInternalResp.
        :type: int
        """
    ...
    def cert_data(self):
        """
        Gets the cert_data of this TrustedCertificateInternalResp.
        X509.v3 trusted certificate in PEM or base64 encoded DER format.

        :return: The cert_data of this TrustedCertificateInternalResp.
        :rtype: str
        """
    ...
    def cert_data(self, cert_data):
        """
        Sets the cert_data of this TrustedCertificateInternalResp.
        X509.v3 trusted certificate in PEM or base64 encoded DER format.

        :param cert_data: The cert_data of this TrustedCertificateInternalResp.
        :type: str
        """
