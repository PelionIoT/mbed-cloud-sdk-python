...
class UserInfoResp(object):
    ...
    """
    def __init__(self, status=None, username=None, password_changed_time=None, groups=None, login_history=None, email_verified=None, created_at=None, object=None, is_gtc_accepted=None, account_id=None, email=None, is_totp_enabled=None, is_marketing_accepted=None, etag=None, full_name=None, address=None, creation_time=None, password=None, phone_number=None, id=None, last_login_time=None):
        """
