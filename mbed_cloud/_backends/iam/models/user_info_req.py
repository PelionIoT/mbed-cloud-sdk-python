...
class UserInfoReq(object):
    ...
    """
    def __init__(self, groups=None, username=None, is_marketing_accepted=None, is_gtc_accepted=None, full_name=None, address=None, password=None, phone_number=None, email=None):
        """
