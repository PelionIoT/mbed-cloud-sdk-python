...
class UserInfoReq(object):
    ...
    """
    def __init__(self, username=None, phone_number=None, is_marketing_accepted=False, groups=None, is_gtc_accepted=False, full_name=None, address=None, password=None, email=None):
        """
