...
class UserInfoReq(object):
    ...
    """
    def __init__(self, username=None, phone_number=None, is_marketing_accepted=False, groups=None, is_gtc_accepted=False, id=None, full_name=None, address=None, password=None, email=None):
        """
    ...
    def id(self):
        """
        Gets the id of this UserInfoReq.
        ID of the user to be adopted, not used in create or invite cases.

        :return: The id of this UserInfoReq.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this UserInfoReq.
        ID of the user to be adopted, not used in create or invite cases.

        :param id: The id of this UserInfoReq.
        :type: str
        """
        if id is None:
