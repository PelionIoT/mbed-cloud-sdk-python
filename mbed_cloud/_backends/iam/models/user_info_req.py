...
class UserInfoReq(object):
    ...
    """
    def __init__(self, phone_number=None, username=None, groups=None, is_gtc_accepted=None, is_marketing_accepted=None, full_name=None, address=None, password=None, email=None):
        """
