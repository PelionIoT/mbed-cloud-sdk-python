...
class RootAdminApi(object):
    ...
    def add_account_certificate_with_http_info(self, account_id, body, **kwargs):
        ...
        resource_path = '/v3/accounts/{accountID}/ca-certificates'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_account_certificate(self, account_id, ca_cert_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_account_certificate(account_id, ca_cert_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_account_certificate_with_http_info(account_id, ca_cert_id, **kwargs)
        else:
            (data) = self.delete_account_certificate_with_http_info(account_id, ca_cert_id, **kwargs)
            return data

    def delete_account_certificate_with_http_info(self, account_id, ca_cert_id, **kwargs):
        """
        Delete CA certificate by ID.
        An endpoint for deleting the CA certificate.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_account_certificate_with_http_info(account_id, ca_cert_id, callback=callback_function)
        ...
        all_params = ['account_id', 'ca_cert_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('ca_cert_id' not in params) or (params['ca_cert_id'] is None):
            raise ValueError("Missing the required parameter `ca_cert_id` when calling `delete_account_certificate`")


        collection_formats = {}

        resource_path = '/v3/accounts/{accountID}/ca-certificates/{ca-cert-id}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountID'] = params['account_id']
    ...
    def delete_account_user_with_http_info(self, account_id, user_id, **kwargs):
        ...
        all_params = ['account_id', 'user_id', 'force']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_account_certificate(self, account_id, ca_cert_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_account_certificate(account_id, ca_cert_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_account_certificate_with_http_info(account_id, ca_cert_id, **kwargs)
        else:
            (data) = self.get_account_certificate_with_http_info(account_id, ca_cert_id, **kwargs)
            return data

    def get_account_certificate_with_http_info(self, account_id, ca_cert_id, **kwargs):
        """
        Get CA certificate by ID.
        An endpoint for retrieving a CA certificate by ID.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_account_certificate_with_http_info(account_id, ca_cert_id, callback=callback_function)
        ...
        # verify the required parameter 'ca_cert_id' is set
        if ('ca_cert_id' not in params) or (params['ca_cert_id'] is None):
            raise ValueError("Missing the required parameter `ca_cert_id` when calling `get_account_certificate`")
    ...
    def get_account_info(self, account_id, **kwargs):
        ...
        :param str include: Comma separated additional data to return. Currently supported: limits, policies
        :return: AccountInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_all_account_api_keys_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'limit', 'after', 'order', 'include', 'filter', 'owner']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_all_account_certificates(self, account_id, **kwargs):
        ...
        :param str order: The order of the records, ASC or DESC; by default ASC
        :param str include: Comma separated additional data to return. Currently supported: total_count
        :param str filter: Filter for the query, for example filter=service%3Dlwm2m,expire%3D180.
    ...
    def get_all_account_certificates_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'limit', 'after', 'order', 'include', 'filter']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_all_accounts(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str status: An optional filter for account status, ENROLLING, ACTIVE, SUSPENDED or DISABLED.
        ...
        :param str filter: Filter for the query, for example filter=tier%3D1 or status%3DACTIVE.
    ...
    def get_all_accounts_with_http_info(self, **kwargs):
        ...
        all_params = ['status', 'tier', 'parent', 'limit', 'after', 'include', 'filter']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def manage_account(self, account_id, **kwargs):
        ...
        :param str status: New status of the account; ACTIVE, SUSPENDED or DISABLED
    ...
    def update_account_certificate(self, account_id, ca_cert_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_account_certificate(account_id, ca_cert_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_account_certificate_with_http_info(account_id, ca_cert_id, body, **kwargs)
        else:
            (data) = self.update_account_certificate_with_http_info(account_id, ca_cert_id, body, **kwargs)
            return data

    def update_account_certificate_with_http_info(self, account_id, ca_cert_id, body, **kwargs):
        """
        Update CA certificate.
        An endpoint for updating existing CA certificates.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_account_certificate_with_http_info(account_id, ca_cert_id, body, callback=callback_function)
        ...
        all_params = ['account_id', 'ca_cert_id', 'body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'ca_cert_id' is set
        if ('ca_cert_id' not in params) or (params['ca_cert_id'] is None):
            raise ValueError("Missing the required parameter `ca_cert_id` when calling `update_account_certificate`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
    ...
    def update_account_user(self, account_id, user_id, body, **kwargs):
        ...
        :param RootAdminUpdateReq body: A rootadmin user object with attributes. (required)
        :return: UserInfoResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
