...
class AccountAdminApi(object):
    ...
    def create_account(self, body, **kwargs):
        ...
        :param str action: Action, either 'create' or 'enroll'.
    ...
    def create_user(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UserCreationReq body: A user object with attributes. (required)
    ...
    def get_all_accounts_with_http_info(self, **kwargs):
        ...
        all_params = ['status__eq', 'tier__eq', 'parent__eq', 'end_market__eq', 'limit', 'after', 'include', 'format']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'end_market__eq' in params:
            query_params['end_market__eq'] = params['end_market__eq']
        if 'limit' in params:
