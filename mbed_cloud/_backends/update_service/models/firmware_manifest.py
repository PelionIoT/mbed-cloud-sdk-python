...
class FirmwareManifest(object):
    ...
    """
    def __init__(self, datafile=None, description=None, timestamp=None, created_at=None, object=None, updated_at=None, manifest_contents=None, etag=None, version=None, device_class=None, id=None, name=None):
        """
    ...
    def version(self):
        """
        Gets the version of this FirmwareManifest.
        The format version of the manifest.

        :return: The version of this FirmwareManifest.
        :rtype: str
        """
    ...
    def version(self, version):
        """
        Sets the version of this FirmwareManifest.
        The format version of the manifest.

        :param version: The version of this FirmwareManifest.
        :type: str
        """
        if version is None:
