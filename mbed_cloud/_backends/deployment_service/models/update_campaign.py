...
class UpdateCampaign(object):
    ...
    """
    def __init__(self, description=None, when=None, created_at=None, object=None, root_manifest_id=None, state=None, finished=None, etag=None, root_manifest_url=None, started_at=None, id=None, device_filter=None, name=None):
        """
