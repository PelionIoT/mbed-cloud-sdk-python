...
------------- | ------------- | -------------
[**v2_endpoints_id_resource_path_delete**](ResourcesApi.md#v2_endpoints_id_resource_path_delete) | **DELETE** /v2/endpoints/{id}/{resourcePath} | Delete a resource
[**v2_endpoints_id_resource_path_get**](ResourcesApi.md#v2_endpoints_id_resource_path_get) | **GET** /v2/endpoints/{id}/{resourcePath} | Read from a resource
[**v2_endpoints_id_resource_path_post**](ResourcesApi.md#v2_endpoints_id_resource_path_post) | **POST** /v2/endpoints/{id}/{resourcePath} | Execute a function on a resource
[**v2_endpoints_id_resource_path_put**](ResourcesApi.md#v2_endpoints_id_resource_path_put) | **PUT** /v2/endpoints/{id}/{resourcePath} | Write to a resource


# **v2_endpoints_id_resource_path_delete**
> AsyncID v2_endpoints_id_resource_path_delete(device_id, _resource_path, no_resp=no_resp)
...
try: 
    # Delete a resource
    api_response = api_instance.v2_endpoints_id_resource_path_delete(device_id, _resource_path, no_resp=no_resp)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ResourcesApi->v2_endpoints_id_resource_path_delete: %s\n" % e)
```
...
# **v2_endpoints_id_resource_path_get**
> AsyncID v2_endpoints_id_resource_path_get(device_id, _resource_path, cache_only=cache_only, no_resp=no_resp)
...
# create an instance of the API class
api_instance = mds.ResourcesApi()
device_id = 'device_id_example' # str | Unique mbed Cloud identifier for the endpoint. Note that the ID needs to be an exact match. You cannot use wildcards here. 
_resource_path = '_resource_path_example' # str | The URL of the resource. 
...
try: 
    # Read from a resource
    api_response = api_instance.v2_endpoints_id_resource_path_get(device_id, _resource_path, cache_only=cache_only, no_resp=no_resp)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ResourcesApi->v2_endpoints_id_resource_path_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **device_id** | **str**| Unique mbed Cloud identifier for the endpoint. Note that the ID needs to be an exact match. You cannot use wildcards here.  | 
 **_resource_path** | **str**| The URL of the resource.  | 
...
# **v2_endpoints_id_resource_path_post**
> AsyncID v2_endpoints_id_resource_path_post(device_id, _resource_path, resource_function=resource_function, no_resp=no_resp)
...
try: 
    # Execute a function on a resource
    api_response = api_instance.v2_endpoints_id_resource_path_post(device_id, _resource_path, resource_function=resource_function, no_resp=no_resp)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ResourcesApi->v2_endpoints_id_resource_path_post: %s\n" % e)
```
...
# **v2_endpoints_id_resource_path_put**
> AsyncID v2_endpoints_id_resource_path_put(device_id, _resource_path, resource_value, no_resp=no_resp)
...
try: 
    # Write to a resource
    api_response = api_instance.v2_endpoints_id_resource_path_put(device_id, _resource_path, resource_value, no_resp=no_resp)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ResourcesApi->v2_endpoints_id_resource_path_put: %s\n" % e)
```
