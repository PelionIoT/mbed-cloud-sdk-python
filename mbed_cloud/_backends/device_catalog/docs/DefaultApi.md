...
# create an instance of the API class
api_instance = device_catalog.DefaultApi()
device = device_catalog.DeviceQueryPostPutRequest() # DeviceQueryPostPutRequest | 
...
api_instance = device_catalog.DefaultApi()
query_id = 'query_id_example' # str | 
device_query = device_catalog.DeviceQueryPatchRequest() # DeviceQueryPatchRequest | 
...
api_instance = device_catalog.DefaultApi()
query_id = 'query_id_example' # str | 
body = device_catalog.DeviceQueryPostPutRequest() # DeviceQueryPostPutRequest | Device query update object.
