...
[**device_event_list_0**](DefaultApi.md#device_event_list_0) | **GET** /v3/devicelog/ | 
[**device_event_retrieve**](DefaultApi.md#device_event_retrieve) | **GET** /v3/devicelog/{device_event_id}/ | 
[**device_event_retrieve_0**](DefaultApi.md#device_event_retrieve_0) | **GET** /v3/device-events/{device_event_id}/ | 
...
# **device_event_list_0**
> DeviceEventPage device_event_list_0(limit=limit, order=order, after=after, filter=filter, include=include)
...
try: 
    api_response = api_instance.device_event_list_0(limit=limit, order=order, after=after, filter=filter, include=include)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->device_event_list_0: %s\n" % e)
```
...
# **device_event_retrieve_0**
> DeviceEventData device_event_retrieve_0(device_event_id)
...
try: 
    api_response = api_instance.device_event_retrieve_0(device_event_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->device_event_retrieve_0: %s\n" % e)
```
