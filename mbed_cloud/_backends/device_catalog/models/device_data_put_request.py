...
class DeviceDataPutRequest(object):
    ...
    """
    def __init__(self, description=None, endpoint_name=None, auto_update=None, host_gateway=None, object=None, custom_attributes=None, device_key=None, ca_id=None, name=None):
        """
