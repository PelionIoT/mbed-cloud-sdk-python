...
class DeviceDataPostRequest(object):
    ...
    """
    def __init__(self, bootstrap_expiration_date=None, bootstrapped_timestamp=None, connector_expiration_date=None, mechanism=None, device_class=None, endpoint_name=None, auto_update=None, device_execution_mode=None, custom_attributes=None, state=None, serial_number=None, firmware_checksum=None, vendor_id=None, description=None, deployed_state=None, object=None, deployment=None, mechanism_url=None, trust_level=None, name=None, device_key=None, manifest=None, ca_id=None):
        """
