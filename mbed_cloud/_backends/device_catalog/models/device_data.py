...
class DeviceData(object):
    ...
    """
    def __init__(self, bootstrap_expiration_date=None, bootstrapped_timestamp=None, connector_expiration_date=None, updated_at=None, mechanism=None, device_class=None, id=None, description=None, endpoint_name=None, auto_update=None, custom_attributes=None, state=None, etag=None, serial_number=None, firmware_checksum=None, manifest_timestamp=None, vendor_id=None, account_id=None, deployed_state=None, object=None, trust_class=None, deployment=None, mechanism_url=None, trust_level=None, name=None, device_key=None, created_at=None, manifest=None, attestation_method=None, ca_id=None):
        """
