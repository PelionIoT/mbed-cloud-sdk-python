...
class WriteDeviceSerializer(object):
    ...
    """
    def __init__(self, vendor_id=None, object=None, description=None, deployed_state=None, auto_update=None, name=None, deployment=None, custom_attributes=None, manifest=None, trust_class=None, provision_key=None, state=None, mechanism=None, device_class=None, mechanism_url=None, serial_number=None, trust_level=None, device_id=None):
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, WriteDeviceSerializer):
            return False
