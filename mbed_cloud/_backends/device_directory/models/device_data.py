...
class DeviceData(object):
    ...
    def __init__(self, bootstrap_expiration_date=None, bootstrapped_timestamp=None, connector_expiration_date=None, updated_at=None, ca_id=None, device_class=None, id=None, account_id=None, endpoint_name=None, auto_update=None, host_gateway=None, device_execution_mode=None, mechanism=None, state=None, etag=None, serial_number=None, firmware_checksum=None, manifest_timestamp=None, vendor_id=None, description=None, deployed_state=None, object=None, endpoint_type=None, deployment=None, mechanism_url=None, trust_level=None, name=None, device_key=None, created_at=None, manifest=None, custom_attributes=None):
        ...
        if bootstrap_expiration_date is not None:
          self.bootstrap_expiration_date = bootstrap_expiration_date
        if bootstrapped_timestamp is not None:
          self.bootstrapped_timestamp = bootstrapped_timestamp
        if connector_expiration_date is not None:
          self.connector_expiration_date = connector_expiration_date
        ...
        if firmware_checksum is not None:
          self.firmware_checksum = firmware_checksum
        if manifest_timestamp is not None:
          self.manifest_timestamp = manifest_timestamp
        if vendor_id is not None:
          self.vendor_id = vendor_id
        if description is not None:
          self.description = description
        if deployed_state is not None:
          self.deployed_state = deployed_state
        ...
        if mechanism_url is not None:
          self.mechanism_url = mechanism_url
